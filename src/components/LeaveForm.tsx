...
const LeaveForm: React.FC<LeaveFormProps> = ({ lang, setLang }) => {
  ...
  const verifyWorker = async (id: string) => {
    ...
    setError('');
    try {
      const baseUrl = import.meta.env.VITE_GOOGLE_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbzPWuuQeS63hy5HcxddKiBxclg-AE_rAXhNsCGvQi4zyWd-k0BUn5OcNvZk-usAQKm2/exec';
